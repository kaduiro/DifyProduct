...
##### 4-9. Code: findings件数カウント (新規追加)

**ノードID**: `count_findings`
...
##### 4-11. Template Transform: 中間出力フォーマット
...
##### 4-12. Variable Aggregator: 中間出力集約
